...
export default function CompactStepCard({ 
    ...
    <div className="relative h-[140px] rounded-lg overflow-hidden bg-gray-200 shadow-md cursor-pointer">
      ...
      {isCreator && onDelete && (
        <button
          ...
          className="absolute top-2 right-2 w-7 h-7 rounded-full bg-red-600 hover:bg-red-700 flex items-center justify-center z-20 shadow-lg transition-colors"
          title="Delete step"
        >
          <svg 
  ...
  return (
    <div className="flex-shrink-0" style={{ width: '80vw', minWidth: '80vw', maxWidth: '80vw' }}>
      <Link 
